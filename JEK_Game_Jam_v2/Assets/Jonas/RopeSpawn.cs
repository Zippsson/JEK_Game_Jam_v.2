...
public class RopeSpawn : MonoBehaviour
{
    ...
    [SerializeField]
    GameObject partPrefab, parentObject, firstObject;
    ...
    public void Spawn()
    {
        ...
        for (int x = 0; x < count; x++)
        {
            //if (x == 0)
            //{
            //    Destroy(firstObject.GetComponent<CharacterJoint>());
            //    if (snapFirst)
            //    {
            //        firstObject.GetComponent<Rigidbody>().constraints = RigidbodyConstraints.FreezeAll;
            //    }
            //}
            //else
            //{
